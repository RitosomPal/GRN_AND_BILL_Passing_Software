<?php
    ...
    if (isset($_POST['Create'])) {
        if (empty($_POST['site_name'])) {
            ...
            $notify = Sites::Create(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }

    // Edit
    if (isset($_POST['Edit'])) {
        if (empty($_POST['site_name']) || empty($_POST['id'])) {
            $notify = array('msg'=>["Insert all required data."],'success'=>false);
        } else {
            $_POST['active'] = (isset($_POST['active']))?1:0;
            $notify = Sites::Edit(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
    ...
    if (isset($_POST['Delete'])) {
        if (empty($_POST['id'])) {
            ...
            $notify = Sites::Delete(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
?>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <button type="button" class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#addModal">Add Site</button>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-info editModal" data-toggle="modal" data-target="#editModal" data-id="<?php echo $v['id']; ?>" data-name="<?php echo $v['name']; ?>" data-active="<?php echo $v['active']; ?>"><i class="fas fa-edit"></i></button>
            ...
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="site_name">Site Name</label>&nbsp;<small class="text-danger"><em>*</em></small>
                        <input type="text" class="form-control" name="site_name" placeholder="Enter Name" required>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="site_name">Site Name</label>&nbsp;<small class="text-danger"><em>*</em></small>
                        <input type="text" class="form-control" id="edit_name" name="site_name" placeholder="Enter Name" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
