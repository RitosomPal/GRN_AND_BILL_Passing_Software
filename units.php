<?php
    ...
    if(!$P['units']['view']) { header('location: ./'); }
    ...
    if (isset($_POST['Create'])) {
        if (empty($_POST['unit_name'])) {
            ...
            $notify = Units::Create(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }

    // Edit
    if (isset($_POST['Edit'])) {
        if (empty($_POST['unit_name']) || empty($_POST['id'])) {
            $notify = array('msg'=>["Insert all required data."],'success'=>false);
        } else {
            $notify = Units::Edit(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
    ...
    if (isset($_POST['Delete'])) {
        if (empty($_POST['id'])) {
            ...
            $notify = Units::Delete(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
?>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <?php if($P['units']['create']) { ?>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal">Add Unit</button>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="unit">Unit</label>&nbsp;<small class="text-danger"><em>*</em></small>
                        <input type="text" class="form-control" name="unit_name" placeholder="Enter Unit" required>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="unit">Unit</label>&nbsp;<small class="text-danger"><em>*</em></small>
                        <input type="text" class="form-control" id="edit_name" name="unit_name" placeholder="Enter Unit" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
