<?php
    ...
    if(isset($_POST['Search'])) {
        if (empty($_POST['supplier']) || empty($_POST['date'])) {
            ...
            $notify = Report::Report1(new Database(), $_SESSION['user']['id'], $_POST['supplier'], $from, $to);
            if ($notify['success']) {
                $F = $notify;
            }
        }
                ...
                <div class="col">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Report 1 (Bill Passed By Supplier)</h3>
                                ...
                                <div class="col" style="overflow-y:auto;">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $c++; ?>.</td>
                                                <td><?php echo $l['siteName']; ?></td>
                                                <td><?php echo $supplier; ?></td>
                                                <td><?php echo $l['item']; ?></td>
                                                <td><?php echo implode('/', array_reverse(explode('-',$l['qtyRecDate']))); ?></td>
                                                <td><?php echo $l['grnNo']; ?></td>
                                                <td><?php echo $l['qtyRec']; ?></td>
                                                <td><?php echo $l['unit']; ?></td>
                                                <td><?php echo implode('/', array_reverse(explode('-',$date))); ?></td>
                                                <td><?php echo $billNo; ?></td>
                                                <td><?php echo $l['billedQty']; ?></td>
                                                <td><?php echo $l['unit']; ?></td>
                                                <td><?php echo intval($l['qtyRec'])-intval($l['billedQty']); ?></td>
                                                <td><?php echo $l['unit']; ?></td>
                                            </tr>
                                            <?php }} ?>
                                        </tbody>
