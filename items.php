<?php
    ...
    if(!$P['items']['view']) { header('location: ./'); }
    ...
    if (isset($_POST['Create'])) {
        if (empty($_POST['item_name'])) {
            ...
            $notify = Items::Create(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }

    // Edit
    if (isset($_POST['Edit'])) {
        if (empty($_POST['item_name']) || empty($_POST['id'])) {
            $notify = array('msg'=>["Insert all required data."],'success'=>false);
        } else {
            $notify = Items::Edit(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
    ...
    if (isset($_POST['Delete'])) {
        if (empty($_POST['id'])) {
            ...
            $notify = Items::Delete(new Database(),$_SESSION['user']['id'],$_POST);
        }
    }
?>
            ...
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="item_name">Item Name</label>&nbsp;<small class="text-danger"><em>*</em></small>
        ...
        <div class="modal-content">
            <form method="post" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="item_name">Item Name</label>&nbsp;<small class="text-danger"><em>*</em></small>
                        <input type="text" class="form-control" id="edit_name" name="item_name" placeholder="Enter Name" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
